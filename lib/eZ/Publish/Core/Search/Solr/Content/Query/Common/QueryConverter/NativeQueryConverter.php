...
namespace eZ\Publish\Core\Search\Solr\Content\Query\Common\QueryConverter;

use eZ\Publish\API\Repository\Values\Content\Query;
use eZ\Publish\Core\Search\Solr\Content\Query\QueryConverter;
use eZ\Publish\Core\Search\Solr\Content\Query\CriterionVisitor;
use eZ\Publish\Core\Search\Solr\Content\Query\SortClauseVisitor;
...
class NativeQueryConverter extends QueryConverter
{
     ...
     * Query visitor.
     *
     * @var \eZ\Publish\Core\Search\Solr\Content\Query\CriterionVisitor
     */
     ...
     * Sort clause visitor.
     *
     * @var \eZ\Publish\Core\Search\Solr\Content\Query\SortClauseVisitor
     */
     ...
     *
     * @var \eZ\Publish\Core\Search\Solr\Content\Query\FacetBuilderVisitor
     */
     ...
     *
     * @param \eZ\Publish\Core\Search\Solr\Content\Query\CriterionVisitor $criterionVisitor
     * @param \eZ\Publish\Core\Search\Solr\Content\Query\SortClauseVisitor $sortClauseVisitor
     * @param \eZ\Publish\Core\Search\Solr\Content\Query\FacetBuilderVisitor $facetBuilderVisitor
     */
