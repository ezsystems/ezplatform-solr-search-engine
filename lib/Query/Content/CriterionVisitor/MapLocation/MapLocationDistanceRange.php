 ...
 * @version //autogentag//
 */
namespace EzSystems\SolrSearchEngine\Query\Content\CriterionVisitor\MapLocation;

use EzSystems\SolrSearchEngine\Query\Content\CriterionVisitor\MapLocation;
